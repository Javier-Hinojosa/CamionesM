      ...
      backgroundColor: Theme.of(context).primaryColor,
       body: ListView(
          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.only(left: 10), child: Align(alignment: Alignment.centerLeft, child: CustomText("Inicia Sesión", style: Theme.of(context).textTheme.titleLarge))),
        Padding(
          padding: const EdgeInsets.only(left: 10,right: 60,top: 20,bottom: 20),
          child: Align(
              alignment: Alignment.centerLeft, child: CustomText("Ingresa los datos requeridos para inciar sesión", style: Theme.of(context).textTheme.titleMedium)
          )
        ),
        Padding(
          ...
          child: ReactiveForm(
            ...
            Row(
              mainAxisSize: MainAxisSize.max,
                ...
                children: [CustomText("¿Olvidaste tu contraseña? ", style: Theme.of(context).textTheme.bodyMedium), CustomText("Recuperar", style: Theme.of(context).textTheme.bodyMedium!.apply(fontWeightDelta: FontWeight.bold.value))]),
            const Padding(padding: EdgeInsets.all(10), child: Divider(height: 2,thickness: 1,)),
            Align(alignment: Alignment.center, child: CustomText("Aun no tienes cuenta, crea una", style: Theme.of(context).textTheme.bodySmall)),
            Padding(
                padding: const EdgeInsets.only(bottom: 10,top: 20,right: 10,left: 10),
                child: CustomButton(title: "Crear cuenta",color: Colors.black,onPressed:  () =>controller.onSingUp())),
      ]),
    );
  }
}
