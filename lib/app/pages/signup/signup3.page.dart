...
class SingUp3Page extends GetView<SingUpController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
            ...
            children: [
              CustomText("Empecemos con tu registro.",
              ...
              _genericWidget(
                  ...
                  Paths.personPlus,
                  "Datos generales",
                  "Completa tus datos para acceder a oportunidades de carga eficiente.",
                  WidgetStatus.closed),
              _genericWidget(
                  context,
                  Paths.location,
                  "Domicilio Fiscal",
                  "Ingresa tu domicilio fiscal para procesar transacciones de carga.",
                  WidgetStatus.enabled),
              _genericWidget(
                  context,
                  Paths.briefcase,
                  "Datos de Representante Legal",
                  "Proporciona información del representante legal para fines legales.",
                  WidgetStatus.enabled),
              _genericWidget(
                  context,
                  Paths.key,
                  "Datos de Acceso",
                  "Crea tus credenciales de acceso para gestionar envíos y servicios.",
                  WidgetStatus.enabled),
              CustomButton(
  ...
  _genericWidget(BuildContext context, String pathIcon, String title,
      String subtitle, WidgetStatus status) {
    switch (status) {
      case WidgetStatus.enabled:
        return _customCard(context, pathIcon, title, subtitle, false);
      case WidgetStatus.disabled:
        return _customCard(context, pathIcon, title, subtitle, true);
      case WidgetStatus.closed:
        return _customCardReduce(context, pathIcon, title, subtitle);
    }
  }
                  ...
                  children: [
                    ...
                    Visibility(
                        ...
                        child: CustomButton(
                            ...
                            onPressed: () =>
                                controller.onDynamicPage(pathIcon)))
                  ]))
        ]).paddingOnly(top: 10, bottom: 10);
  }

  _customCardReduce(
      BuildContext context, String pathIcon, String title, String subtitle) {
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                SizedBox(
                    ...
                    child: CustomIconButton(
                        onPressed: () => controller.onDynamicPage(pathIcon),
                        icon: Icons.edit)),
                SizedBox(width: Get.width * 0.035),
                SizedBox(
                    height: Get.height * 0.05,
