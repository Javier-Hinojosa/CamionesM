...
class SettingsController extends GetxController with GetSingleTickerProviderStateMixin{
  ...
  static final List<GenericItem> profileItems = [
    ...
    GenericItem(ProfileItems.registerNewTrip,Icons.assignment_add,"Registrar nuevo viaje"),
    GenericItem(ProfileItems.myTrips,FontAwesomeIcons.flag,"Mis viajes"),
    GenericItem(ProfileItems.solicitudes,FontAwesomeIcons.envelope,"Solicitudes"),
    GenericItem(ProfileItems.myEarnings,Icons.payments_outlined,"Mis ganancias")
  ];
