            ...
            child: Column(
                ...
                children: [
                      ...
                      SizedBox(
                        ...
                        child: const Card(
                          color: Globals.principalColor,
                            child: Icon(Icons.sensors_outlined,color: Colors.black,size: 30))),
                  ...
                  Align(
                      ...
                      child: CustomText("Ver detalles",style: titleSmall.apply(fontWeightDelta: FontWeight.w100.index))),
                  SizedBox(height: Get.height * 0.02)
