...
class TripRegisterGeneralPage extends GetView<TripRegisterController>{
                ...
                child: Column(
                  children: [
                   ...
                   SizedBox(height: Get.height*0.02),
                    ...
                    SizedBox(height: Get.height*0.02),
                    _customDropDown(Keys.stateDestiny,"Estado","Selecciona el estado de origen",controller.states(),(p0)=> controller.onChangeStateOrigin(p0.value)),
                    SizedBox(height: Get.height*0.02),
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Flexible(
                              flex:8,
                              child: _customDropDown(Keys.municipalDestiny,"Alcaldía o municipio","Elije tu municipio de origen",controller.municipalsOriginSelect(),(p0) {})),
                          const Spacer(),
                          Flexible(
                              flex:4,
  ...
  Widget _customDropDown(String key,String labelText, String hintText, List items, void Function(FormControl<dynamic>)? onChanged ) {
    return  CustomReactiveDropDown(key,
        ...
        items: items
            .map((e) =>
            DropdownMenuItem(value: e, child: Text(e,softWrap: true,overflow: TextOverflow.ellipsis)))
            .toList());
  }
